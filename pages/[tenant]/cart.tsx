...
const Cart = (data : Props) => {
  ...
  const [shipingTime, setShipingTime] = useState(0)
  const [shippingAddress, setShippingAddress] = useState('')
  const handleShippingCalc = () => {
    setShippingAddress('Rua Nova')
    setShipingPrice(9.50)
    setShipingTime(20)
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.shippingArea}>
        <div className={styles.shippingTitle}></div>
        ...
        {shipingTime > 0  &&
          <div className={styles.shippingInfo}>
            ...
            <div className={styles.shippingTimeText}>
              Receba em ate {shipingTime} minutos
            </div>
            <div className={styles.shippingPrice}
              style={{color: data.tenant.mainColor}}
              >{formatter.formatPrice(shipingPrice)}</div>
            </div>
          </div>
        }
      </div>
      ...
      <div className={styles.resumeArea}>
        ...
        <div className={styles.resumeItem}>
          ...
          <div className={styles.resumeRight}>
            {shipingPrice > 0 ? formatter.formatPrice(shipingPrice) : '--'}
          </div>
        </div>
        ...
        <div className={styles.resumeItem}>
          ...
          >
            {formatter.formatPrice(shipingPrice + subtotal)}    </div>
        </div>
